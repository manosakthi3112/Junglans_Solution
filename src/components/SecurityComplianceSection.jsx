  ...
  return (
    <div className="glass-panel rounded-3xl p-8 md:p-12 bg-white border border-[#A7F3D0] shadow-xl my-16">
      <div className="text-center max-w-3xl mx-auto mb-10">
        ...
        <h2 className="font-heading text-4xl font-bold text-[#08090c] tracking-tight">Built for Mission-Critical Defense & Enterprise Security</h2>
        <p className="font-body text-base text-slate-600 mt-3">
          Our 20 software products adhere to strict enterprise security standards with zero external telemetry.
        </p>
      </div>

      {/* Badges Grid */}
      <div className="grid md:grid-cols-5 gap-4 mb-8 font-mono text-xs">
        {complianceBadges.map((badge, idx) => (
          ...
          >
            ...
            <div className="font-bold font-heading text-sm">{badge.title}</div>
          </button>
        ))}
      </div>

      {/* Active Detail Display */}
      <div className="p-6 rounded-2xl bg-[#F4FBF7] border border-[#A7F3D0] text-center max-w-2xl mx-auto">
        ...
        <h3 className="font-heading text-2xl font-bold text-[#08090c] mb-2">
